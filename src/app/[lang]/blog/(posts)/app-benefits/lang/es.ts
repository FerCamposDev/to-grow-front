...
export const es = {
  ...
  content: {
    ...
    body: {
      ...
      section3: {
        title: "Ejemplos de características que podría tener su applicación",
        desc: "A continuacion le dejamos algunos ejemplos que una applicación podría tener para captar el interés de sus clientes:",
        items: [
          {
