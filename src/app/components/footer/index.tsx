      ...
      <div className="container mx-auto py-5">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 justify-between">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="mt-4">
              <a href="terms.html" target="_blank" className="mb-2 text-gray-300 flex items-center"><i className="fas fa-angle-right text-secondary me-2"></i>Terms of use</a>
              <a href="policies.html" target="_blank" className="mb-2 text-gray-300 flex items-center"><i className="fas fa-angle-right text-secondary me-2"></i>Privacy Policy</a>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="text-center md:text-left">
            ...
            <span className="text-gray-200">
              <a href="/index.html" className="text-white font-semibold">To<span className="text-secondary">Grow</span></a>
              , All right reserved.
            </span>
          </div>
          <div className="text-center md:text-right">
            <span className="text-gray-300">Designed By
              <a href="/index.html" className="text-white font-semibold ml-1">To<span className="text-secondary">Grow</span></a>
            </span>
          </div>
        </div>
      </div>
